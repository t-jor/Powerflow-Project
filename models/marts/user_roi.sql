...
-- how to display costumer_roi for organic customers? 
-- >>> wenn gar kein Invest, dann rauslassen. Alternativ kleinen Betrag ansetzen, bspw. Overhead und ROI berechnen.
-- >>> idealerweise organic und paid customers separat ausweisen/ reporten